package com.runion.laserbox.gcode.sender.monitors;

import com.runion.laserbox.gcode.sender.sender.GCodeSender;
...
class UploadFileMonitor extends GcodeFileAddedMonitor {
    ...
    public UploadFileMonitor(com.runion.laserbox.gcode.sender.sender.GCodeSender GCodeSender) {
